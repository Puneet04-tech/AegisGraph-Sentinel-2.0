...
def test_create_record():
    payload = {"record_id": "rec-integ-63-001", "tenant_id": TENANT_ID, "decision_id": "dec-777", "action_taken": "BLOCK_IP", "rationales": ["High anomalous traffic", "Known bad IP"], "confidence": 0.99}
