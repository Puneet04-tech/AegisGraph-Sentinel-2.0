...
class ClusterEngine:
    ...
    def detect_clusters_connected_components(
        self, min_size: int = 2, risk_threshold: float = 0.0
    ) -> List[FraudCluster]:
    ...
    def detect_clusters_bfs(
        self, start_entity_id: Optional[str] = None, min_size: int = 2, max_depth: int = 3
    ) -> List[FraudCluster]:
    ...
    def detect_clusters_dfs(
        self, start_entity_id: Optional[str] = None, min_size: int = 2, max_depth: int = 5
    ) -> List[FraudCluster]:
    ...
    def split_cluster(
        self, cluster_id: str, entity_ids: List[str]
    ) -> Tuple[Optional[FraudCluster], Optional[FraudCluster]]:
